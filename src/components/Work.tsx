...
const personalProjects: PersonalProject[] = [
  {
    ...
    description:
      'Sistema completo para academias gerenciarem alunos, treinos, dietas, avaliações, mensalidades — com app do aluno em React Native. Tudo construído por uma pessoa só.',
    story:
      'Comecei como tentativa de organizar planilha de uma academia local — virou plataforma com landing pública, motor de mensalidades, biblioteca de exercícios, prescrição de dieta e app móvel.',
    features: [
      'Multi-tenant · 1 aluno em N academias',
      'Treino + dieta com macros',
      'Avaliação física · série temporal',
      'Mensalidade automática + inadimplência',
      'App nativo iOS/Android (Expo)',
      'Demo público com seed automático',
    ],
    tech: ['React 19', 'Vite', 'Tailwind v4', 'Laravel', 'TypeScript', 'MySQL', 'React Native', 'Expo'],
  ...
  },
  {
    ...
    description:
      'Sistema para bares, restaurantes e lanchonetes operarem comanda, caixa, cozinha, delivery e cardápio digital — com canal WhatsApp e cardápio público por slug.',
    story:
      'Multi-tenant real — cada cliente acessa pela URL `app/:slug`. Tem painel SaaS pra eu administrar tenants, planos, suporte e segurança. Da contratação ao primeiro pedido em poucos minutos.',
    features: [
