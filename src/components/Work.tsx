...
const personalProjects: PersonalProject[] = [
  ...
  },
  {
    ...
    description:
      'SaaS para bares e restaurantes operarem comanda, caixa, cozinha (KDS), delivery e mesa via QR code — com canal WhatsApp e cardápio público por slug. Redesign completo com design system próprio.',
    story:
      'Multi-tenant real — cada cliente acessa pela URL `app/:slug`. Design system dark premium na operação e tema claro no cardápio do cliente, mobile-first de ponta a ponta (bottom nav, bottom-sheets, touch targets). Painel SaaS com 2FA obrigatório pra administrar tenants, planos e suporte.',
    features: [
      'Multi-tenant por slug · isolamento por cliente',
      'Design system próprio · dark na operação, light no cliente',
      'Comanda, caixa e fechamento em tempo real',
      'Delivery e mesa QR com cardápio público mobile-first',
      'Cozinha (KDS) com tempo por cor e toque grande',
      'Integração WhatsApp por status de pedido',
      'Painel SaaS · tenants, planos, suporte, 2FA server-side',
    ],
    tech: ['React', 'Vite', 'PrimeReact', 'Laravel', 'Node.js', 'MySQL', 'WhatsApp API'],
    status: 'em desenvolvimento · multi-tenant',
    logo: '/projects/logos/mesa10.svg',
    logoBg: 'bg-bg3',
    groups: [
      {
        ...
        perfil: 'gerente',
        shots: [
          { src: '/projects/mesa10-pizzaria-pedidos.png',   caption: 'Pedidos em tempo real · mesas, balcão, retirada e delivery' },
          { src: '/projects/mesa10-pizzaria-cozinha.png',   caption: 'Cozinha (KDS) · tempo por cor, ações de toque grande' },
          { src: '/projects/mesa10-pizzaria-cardapio.png',  caption: 'PDV · cardápio, adicionais e lançamento em comanda' },
          { src: '/projects/mesa10-pizzaria-combos.png',    caption: 'Combos · montagem por etapas' },
          { src: '/projects/mesa10-pizzaria-dashboard.png', caption: 'Dashboard · vendas, ticket médio e top produtos' },
          { src: '/projects/mesa10-pizzaria-config.png',    caption: 'Configurações · horários, frete, pagamento, WhatsApp' },
        ],
      },
      {
        ...
        perfil: 'customer',
        shots: [
          { src: '/projects/mesa10-customer-mobile-pedido.png', caption: 'Cardápio público mobile · sacola persistente e checkout guiado', mobile: true },
        ],
      },
    ],
  },
