...
const personalProjects: PersonalProject[] = [
  ...
  },
  {
    ...
    description:
      'SaaS multi-tenant para bar e restaurante. Quatro destinos — Operar, Cozinha, Cardápio e Negócio — no lugar de vinte telas. Salão, delivery, balcão e mesa por QR caem na mesma fila, e o cliente pede pelo celular sem instalar nada.',
    story:
    ...
    tech: ['React', 'Vite', 'Laravel 12', 'MariaDB', 'Evolution API', 'Google Maps', 'Docker'],
    ...
    groups: [
      {
        ...
        perfil: 'gerente',
        shots: [
          { src: '/projects/mesa10-pizzaria-pedidos.png',   caption: 'Operar · planta do salão com valor e tempo de cada mesa' },
          { src: '/projects/mesa10-pizzaria-cozinha.png',   caption: 'Cozinha · um card por pedido, praça por item e modo TV' },
          { src: '/projects/mesa10-chat-pedido.png',        caption: 'Chat do pedido · falo com o cliente sem sair do sistema' },
          { src: '/projects/mesa10-pizzaria-cardapio.png',  caption: 'Cardápio · promoção, "no cardápio" e "acabou hoje" por item' },
          { src: '/projects/mesa10-pizzaria-combos.png',    caption: 'Combo · editor de um lado, o que o cliente vê do outro' },
          { src: '/projects/mesa10-pizzaria-dashboard.png', caption: 'Relatório · vendido em aberto + fechado e venda por hora' },
          { src: '/projects/mesa10-pizzaria-config.png',    caption: 'Ajustes · áreas de entrega desenhadas no mapa, com preço e prazo' },
        ],
      },
      {
        ...
        perfil: 'customer',
        shots: [
          { src: '/projects/mesa10-customer-mobile-pedido.png', caption: 'Cardápio público · seções, fotos e preço promocional', mobile: true },
          { src: '/projects/mesa10-mesa-qr.png',                caption: 'Mesa por QR · pede do celular, chama o atendente e pede a conta', mobile: true },
        ],
      },
    ],
  },
