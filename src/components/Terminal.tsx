...
const commands: Record<string, () => Line[]> = {
  ...
  projects: () => [
    { kind: 'sys', text: '── IB System ──' },
    { kind: 'out', text: '1. Lotemobile / WalletLote' },
    { kind: 'out', text: '   SaaS multi-tenant · Laravel + 2 SPAs React · AWS ECS' },
    { kind: 'out', text: '' },
    { kind: 'out', text: '2. IB3Capital' },
    { kind: 'out', text: '   Plataforma de gestão de capital · Laravel + React' },
    { kind: 'out', text: '' },
    { kind: 'out', text: '3. IBticket' },
    { kind: 'out', text: '   Venda e gestão de ingressos online · checkout + QR' },
    { kind: 'out', text: '' },
    { kind: 'sys', text: '── Pessoais ──' },
    { kind: 'out', text: '4. HASGym' },
    { kind: 'out', text: '   Gestão de academias · alunos, planos, treinos' },
    { kind: 'out', text: '' },
    { kind: 'out', text: '5. SistemaBar' },
